...
class TestErrorHandling:
    ...
    def test_mapdl_command_failure(self, mock_context):
        ...
        mock_context.fastmcp._app_context.pool[0].run.side_effect = RuntimeError(
    ...
    def test_write_comment_failure(self, mock_context):
        ...
        mock_context.fastmcp._app_context.pool[0].com.side_effect = RuntimeError(
    ...
    def test_invalid_context_structure(self):
        ...
        app_ctx = AppContext()
        app_ctx.pool = None
        invalid_context.fastmcp = MagicMock()
        invalid_context.fastmcp._app_context = app_ctx
    ...
    def test_mapdl_timeout(self, mock_context):
        ...
        # Simulate a timeout
        mock_context.fastmcp._app_context.pool[0].run.side_effect = TimeoutError(
    ...
    def test_empty_command_string(self, mock_context):
        ...
        mock_context.fastmcp._app_context.pool[0].run.assert_called_once_with("")
