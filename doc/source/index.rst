...
.. grid:: 2 2 3 3
    ...
    .. grid-item-card:: :fa:`tools` Explore available tools
        ...
        Discover all the MCP tools available for
        MAPDL control, Python execution, visualization,
    ...
    .. grid-item-card:: :fa:`question` Find help or report issues
        :link: https://github.com/ansys/pymapdl-mcp/issues
        :link-type: url
